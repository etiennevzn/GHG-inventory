...
Calcul générique : calcul des émissions d’un trajet puis agrégation des émissions de tous les trajets sur l’année considérée. Émissions d’un trajet = distance parcourue * facteur d’émission du mode de déplacement (par km parcouru ou par passager-km)
